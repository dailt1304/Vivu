...
{
    public class UpdateTripLocationCommandValidatorTests
    {
        private readonly UpdateTripLocationValidator _validator;

        public UpdateTripLocationCommandValidatorTests()
        {
            _validator = new UpdateTripLocationValidator();
        }
        ...
        public void Validate_CompleteValidCommand_PassesAllValidations()
        {
            var command = new UpdateTripLocationCommand
            {
                ...
                Note = "Updated: Visit the art gallery",
                TransportMode = "Taxi"
            };
